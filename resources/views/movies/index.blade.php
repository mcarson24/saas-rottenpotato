        ...
        <thead>
            <tr>
                <th class="{{ $sort_order == 'title' ? 'sorted' : '' }}">
                    <a href="{{ action('MoviesController@index', ['sort' => 'title', 'order' => $nextDirection]) }}" id="title_header">Movie Title</a>
                </th>
                <th>Rating</th>
                <th class="{{ $sort_order == 'release_date' ? 'sorted' : '' }}">
                    <a href="{{ action('MoviesController@index', ['sort' => 'release_date', 'order' => $nextDirection]) }}" id="release_date_header">Release Date</a>
                </th>
                <th>More Info</th>
            </tr>
        </thead>
